...
The time series aggregation function uses dependencies that are not automatically installed with pybalmorel: ripgrepy (a Python wrapper for [ripgrep](https://github.com/BurntSushi/ripgrep)) and the time series aggregation package [tsam](https://tsam.readthedocs.io/en/latest/). Install them into your virtual environment with pip:
